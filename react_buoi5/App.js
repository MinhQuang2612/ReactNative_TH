...
// Import ảnh local từ thư mục assets
const images = {
...
export default function VsmartJoy3Screen() {
  ...
  const MainScreen = () => (
    <ScrollView style={styles.container}>
      <Image
        source={selectedColorInfo.image}
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.ratingContainer}>
          {[1, 2, 3, 4, 5].map((_, index) => (
            <AntDesign key={index} name="star" size={18} color="#FFC107" />
          ))}
        ...
        <View style={styles.promotionContainer}>
          ...
          <AntDesign name="questioncircleo" size={16} color="#3F51B5" />
        </View>
        <TouchableOpacity style={styles.colorButton} onPress={() => setShowColorSelection(true)}>
    ...
    <View style={styles.colorSelectionContainer}>
      ...
      <View style={styles.colorOptionsContainer}>
        {colors.map((color) => (
          <TouchableOpacity
            key={color.code}
            style={[styles.colorOption, { backgroundColor: color.code }]}
      ...
      <TouchableOpacity 
        ...
        onPress={() => setShowColorSelection(false)}
      >
